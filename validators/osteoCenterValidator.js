...
const osteoCenterSchema = Joi.object({
    ...
    osteos: Joi.array().items(osteoSchema).optional().allow(null), // Tableau optionnel
    staff: Joi.array().items(osteoSchema).optional().allow(null),
});

module.exports = { osteoSchema, osteoCenterSchema };
